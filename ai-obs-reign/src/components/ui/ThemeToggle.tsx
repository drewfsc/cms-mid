    ...
    <label className={`theme-switch ${className}`}>
      ...
      <style jsx>{`
        .theme-switch {
          ...
          --sun-bg: linear-gradient(40deg, #ff0f7b, #f89b29);
          --moon-bg: linear-gradient(40deg, #ffd0fb, #238cf5);
          --spot-color: #94a1b2;
        ...
        .theme-switch__sun-moon-container {
          ...
          margin: calc((var(--circle-container-diameter) - var(--sun-moon-diameter)) / 2);
          border-radius: 50%;
        ...
        /* Dark mode styles */
        :global(.dark) .theme-switch__container {
          background-color: #1a1a2e;
        }

        :global(.dark) .theme-switch__sun-moon-container {
